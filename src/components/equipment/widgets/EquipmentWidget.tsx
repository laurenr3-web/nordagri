...
export const EquipmentWidget: React.FC<EquipmentWidgetProps> = ({ data, loading, size }) => {
  ...
  const equipmentToShow = Array.isArray(data) ? data.slice(0, displayLimit) : [];
