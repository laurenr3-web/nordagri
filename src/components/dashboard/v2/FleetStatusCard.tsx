      ...
      {isLoading ? (
        ...
        <div className="grid grid-cols-3 gap-2">
          <div className="rounded-lg bg-emerald-500/10 p-2.5 text-center">
            ...
            <div className="text-[10px] text-muted-foreground uppercase tracking-wide">Opérationnels</div>
          </div>
          <div className="rounded-lg bg-amber-500/10 p-2.5 text-center">
            ...
            <div className="text-[10px] text-muted-foreground uppercase tracking-wide">Maintenance</div>
          </div>
          <div className="rounded-lg bg-destructive/10 p-2.5 text-center">
            ...
            <div className="text-[10px] text-muted-foreground uppercase tracking-wide">Hors service</div>
          </div>
        </div>
      )}
    </div>
