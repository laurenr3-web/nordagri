    ...
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-4 mb-6 w-full">
      <Card className="rounded-xl sm:rounded-lg w-full max-w-full">
        <CardHeader className="pb-1 sm:pb-2">
          <CardTitle className="text-sm sm:text-base font-medium">Time Today</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="text-2xl sm:text-2xl font-bold min-h-[44px] flex items-center justify-center">
      ...
      <Card className="rounded-xl sm:rounded-lg w-full max-w-full">
        <CardHeader className="pb-1 sm:pb-2">
          <CardTitle className="text-sm sm:text-base font-medium">Time This Week</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="text-2xl sm:text-2xl font-bold min-h-[44px] flex items-center justify-center">
      ...
      <Card className="rounded-xl sm:rounded-lg w-full max-w-full">
        <CardHeader className="pb-1 sm:pb-2">
          <CardTitle className="text-sm sm:text-base font-medium">Time This Month</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="text-2xl sm:text-2xl font-bold min-h-[44px] flex items-center justify-center">
